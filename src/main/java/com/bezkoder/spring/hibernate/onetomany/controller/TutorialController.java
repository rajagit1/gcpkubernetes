...
static
  ...
  @Cacheable(cacheNames = "ProductFeaturesByProgram" , key = "#title")  
  public String getAllTutorials(@RequestParam(required = false) String title) {
    List<Tutorial> tutorials = new ArrayList<Tutorial>();

    System.out.println("Cache Test:"+ retCache("ProductFeaturesByProgram"));
    if (title == null)
  ...
  //
  public static Map<Object,Object> retCache(String cacheName) {
	  Map<Object,Object> datalist = redisTemplate.opsForHash().entries(cacheName);
	  return datalist;
  }
